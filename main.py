...
# Randomize the data
# Get the indexes, permutate them randomly,
# and then reassign them to the existing elements to shuffle them
california_housing_dataframe = california_housing_dataframe.reindex(
    np.random.permutation(
        california_housing_dataframe.index))

# Change the value to thousands
california_housing_dataframe["median_house_value"] /= 1000


# Create an input function. This will provide instructions on preprocessing,
...
def my_input_fn(features, targets, batch_size=1, shuffle=True, num_epochs=None):
    ...
    # Construct a dataset, adn configure batching/repeating.
...
def train_model(learning_rate, steps, batch_size, input_feature):
    ...
    Args:
        ...
        input_feature: A 'string' specifying a column from 'california_housing_dataframe' to use as an input feature.
    ...
    for period in range(0, periods):
        ...
        # Add the loss metric from this period to our list
